...
EbN0dB_start = 1; EbN0dB_stop = 3.5;
...
figure(2)
semilogy(EbN0dB,BER_SSCD,'-p');
hold on;
semilogy(EbN0dB,BLER_SSCD,'-p');
semilogy(EbN0dB,BER_BP,'-p');
semilogy(EbN0dB,BLER_BP,'-p');

legend('BER SSC','BLER SSC','BER BP','BLER BP');
