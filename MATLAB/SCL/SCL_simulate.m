...
for i_E = 1:length(EbN0dB)
	...
	parfor i_m = 1:Nblocks
        ...
        % SC Decoding
        [msg_hat,PM] = decode_SCL(LLR, N, l, info_check_vec, data_pos);
    ...
    BLER_SCL(1,i_E) = fer_SCL/(Nblocks_count);
